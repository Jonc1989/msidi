...
@section('content')
<div id="opal-online" class="col-md-12 col-sm-12 col-xs-12 clear-pads" ng-controller="OpalOnlineController">


    <div class="col-md-12 col-sm-12 col-xs-12 top-info">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 top-img ">
            <img class="" src="http://ms-idi.eu/wp-content/uploads/2014/10/Layer-48.png">
        </div>

    </div>

    <div id="layer1" class="col-md-12 col-sm-12 col-xs-12">
        <div class="col-lg-12">
